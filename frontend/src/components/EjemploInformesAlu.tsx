...
return (
    ...
    renderSummaryRow={({ column, data }) =>
      column.field === "birthYear"
        ...
        : undefined
    }//Realizar suma de una columna

    title='Coleccion'
    //Esto de aquí abajo es lo nuevo. Dentro de options pondremos la parte de exportación
    options={{
      headerStyle: {
            backgroundColor: '#5f70ce', //color de fondo
            //color: Aquí va el color de la letra  
      },
      //draggable: false ...Hace no movibles las columnas del informe 
      columnsButton: true, //Hace que el usuario pueda elegir qué columnas mostrar
      filtering: true, //Filtrado por cada columna
